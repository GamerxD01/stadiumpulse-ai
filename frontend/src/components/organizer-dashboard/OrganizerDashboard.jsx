...
import GreenOpsPanel from './GreenOpsPanel';
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <DecisionBriefPanel
        ...
        loading={loadingDecisionBrief}
        onGenerateDecisionBrief={onGenerateDecisionBrief}
      />

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <TransportationPanel
          transitStatus={stadiumState.transit_status}
          recommendation={transportationRecommendation}
          loading={loadingTransportation}
          onGenerateRecommendation={onGenerateTransportationRecommendation}
        />
        <GreenOpsPanel
          optimizations={sustainabilityOptimizations}
          loading={loadingOptimizations}
          onGenerateOptimizations={onGenerateSustainabilityOptimizations}
        />
      </div>
